...
const insertWarning = () => editorInstance.blocks.insert("warning", { medicalLifeTitle: "주의", message: "경고 내용" });
...
const insertTable = () => editorInstance.blocks.insert("table", { medicalLifeContent: [[""]] });
...
const getEditorData = async () => {
  ...
  formData.append("medicalLifeContent", JSON.stringify(editorData)); // JSON 데이터 저장
  ...
  return { medicalLifeContent: editorData, images: images.value }; // 저장된 데이터 반환
};
